...
<div class="row">
    ...
    <div class="row" >
        <div class="col-md-12 content content-d" url=""  >
            <h1 class="h1-top"><span class="glyphicon glyphicon-share"></span>  我加入的分享圈</h1>
        </div>
        <?php if(is_array($shares)): $i = 0; $__LIST__ = $shares;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shares): $mod = ($i % 2 );++$i;?><div class="col-md-12 content content-d" url="">
            <div class="col-md-12 content-user" >
                <a class="user-pic delete" alt="<?php echo ($shares["id"]); ?>" title="<?php echo (session('users_id')); ?>">退出</a>
                <span class="infos">
    ...
    $(function(){
        $('.delete').click(function(){
            ...
            layer.open({
                ...
                shadeClose: false,
                yes: function(){
                    $.post('__ROOT__/Users/out',{sid:sid,uid:uid},function(data){
                        var m=data.message;
                        if(m=='fail'){
                            layer.open({
                                content: '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;退出失败!',
