...
<html lang="zh-CN">
<head>
    <title><?php echo ($infos["title"]); ?>-帖子列表</title>
...
<div class="row">
    ...
    <div class="row" >
        <div class="col-md-12 content content-d" url=""  >
            <h1 class="h1-top"><span class="glyphicon glyphicon-share"></span>  “<?php echo ($infos["title"]); ?>”的帖子</h1>
        </div>
        <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$articles): $mod = ($i % 2 );++$i;?><div class="col-md-12 content content-d" url="" >
            <div class="col-md-12 content-user" >
                ...
                <?php if(!$articles['is_top']): ?><a class="set-top" alt="<?php echo ($articles["id"]); ?>" title="<?php echo ($articles["sid"]); ?>">置顶</a><?php endif; ?>
                <span class="infos">
