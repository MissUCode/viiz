    ...
    <div class="widget-content nopadding">
        <form action="__ROOT__/Zoneadmin/Admin/add_action" method="post" class="form-horizontal">
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" class="span11" placeholder="用户名" name="admin_name" value="<?php echo ($info["admin_name"]); ?>" />
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <label>
                        <input type="radio" name="lev" <?php if($info["lev"] == 1): ?>checked="checked"<?php endif; ?> value="1" />
                        超级管理员</label>
                    <label>
